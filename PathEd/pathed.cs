...
namespace pathed
{
    ...
    class pathed
    {
        ...
        private void Run(string[] args)
        {
            ...
            Args = new InputArgs(
                "PATHED",
                string.Format( "Version {0}\r\nFreeware written by Gerson Kurz (http://p-nand-q.com)", AppVersion.Get()));
        ...
        private void SlimPath()
        {
            ...
            StringList.MakeUnique(ref vars, StringComparison.OrdinalIgnoreCase);
        ...
        private void ListPath()
        {
            ...
            if (PathVariable == null)
            {
                Console.WriteLine("Variable '{0}' does not exist.", EnvironmentVariableName);
            }
            else
            {
                string[] tokens = PathVariable.Split(';');
