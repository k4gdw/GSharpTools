...
namespace GSharpTools
{
    ...
    {
        public static void Filter(List<string> source, IEnumerable<string> itemsToRemove, StringComparison sc)
        {
        ...
        public static bool ExistsInSubset(List<string> items, int size, string s, StringComparison sc)
        {
            int nCount = 0;
